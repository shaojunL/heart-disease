...
*  MaxHR appeared highest in Decision Tree, indicating it is the most contributing factor
*  MaxHR had the highest accuracy as well as magnitude for its coefficient for (?) in Logistic Regression
